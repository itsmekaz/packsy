    ...
    <main class="container-fluid p-0">
        <section class="container hero d-flex justify-content-between align-items-center rounded-5 mt-4">
            <div class="left w-50">
                ...
                <p class="fw-normal mb-4">Live for Influential and Innovative fashion!</p>
                <a href="" class="btn btn-prim">Shop Now</a>
            </div>
        ...
        <section class="new mt-5 py-3">
            <div class="container d-flex flex-column">
                <div class="title d-flex justify-content-between align-items-end mb-4">
                    ...
                    <a href="" class="btn btn-sec text-uppercase">Explore More</a>
                </div>
                <div class="card-group mt-4 d-flex flex-wrap column-gap-3">
                    ...
                    <div class="card text-center rounded-5 overflow-hidden">
                        <img class="card-img-top rounded-5" src="assets/images/new/bag-2.jpg" alt="Elizabeth" />
                        <div class="card-body text-uppercase p-4">
                    ...
                    <div class="card text-center rounded-5 overflow-hidden">
                        <img class="card-img-top rounded-5" src="assets/images/new/bag-3.jpg" alt="Elizabeth" />
                        <div class="card-body text-uppercase p-4">
                    ...
                    <div class="card text-center rounded-5 overflow-hidden">
                        <img class="card-img-top rounded-5" src="assets/images/new/bag-4.png" alt="Elizabeth" />
                        <div class="card-body text-uppercase p-4">
        ...
        <section class="review mt-5">
            <div class="title container d-flex justify-content-between align-items-end mb-5">
                <h2 class="w-60">OUR HAPPY CUSTOMERS</h2>
                <div class="arrow d-flex justify-content-between align-items-center gap-3">
                    <button class="btn btn-prev btn-sec d-flex justify-content-center align-items-center" data-action="prev">
                        <img src="assets/images/review/chevron_forward.svg" alt="Previous">
                    </button>
                    <button class="btn btn-next btn-sec d-flex justify-content-center align-items-center" data-action="next">
                        <img src="assets/images/review/chevron_forward.svg" alt="Next">
                    </button>
                </div>
            </div>
            <div class="card-wrapper overflow-hidden position-relative">
                <div class="card-group d-flex gap-3 m-auto">
                    <div class="card rounded-4 p-4 size-card">
                        ...
                        <p class="card-text">I'm blown away by the quality and style of the clothes I received from Shop.co. From casual wear to elegant dresses, every piece I've bought has exceeded my expectations.</p>
                    </div>
                    <div class="card rounded-4 p-4 size-card">
                        <div class="star d-flex justify-content-start align-items-center gap-1 mb-3">
                            <?php for($i = 0; $i < 5; $i++) :?>
